...
## Project Structure
- `client/src/pages/` - Dashboard, Schedule, Employees, Login, SteepIn pages
...
- **SteepIn**: No login required, for clock-in/out and break tracking. Requires 4-digit employee passcode for actions.
